class Komputer:
    def init(self, merk, jenis, harga):
        self.jenis = jenis
        self.harga = harga
        self.merk = merk
...
class Processor(Komputer):
    def init(self, merk, jenis, harga, jumlah_core, kecepatan_processor) -> None:
        Komputer.init(self, merk, jenis, harga)
        self.nama = "Processor"
        self.jumlah_core = jumlah_core
        self.kecepatan_processor = kecepatan_processor

class RAM(Komputer):
    def init(self, merk, jenis, harga, kapasitas):
        Komputer.init(self, merk, jenis, harga)
        self.nama = "RAM"
        self.kapasitas = kapasitas

class HDD(Komputer):
    def init(self, merk, jenis, harga, kapasitas, rpm):
        Komputer.init(self, merk, jenis, harga)
        self.nama = "SATA"
        self.kapasitas = kapasitas
        self.rpm = rpm
...
class VGA(Komputer):
    def init(self, merk, jenis, harga, kapasitas):
        ...
        self.kapasitas = kapasitas
class PSU(Komputer):
    def init(self, merk, jenis, harga, daya):
        Komputer.init(self, merk, jenis, harga)
        self.nama = "PSU"
        self.daya = daya
